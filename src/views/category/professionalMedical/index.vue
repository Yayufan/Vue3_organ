...
<template>
  <section class="professional-medical-section">
    <el-card>
      ...
      -->
      <CustomCategory :categoryTable="categoryTable" :saveOrUpdateCategory="saveOrUpdateProfessionalMedicalCategory"
...
//給子組件的新增/修改回調函數
const saveOrUpdateProfessionalMedicalCategory = async (data: any) => {
